...
1.1 O Projeto Arduino 15

1.2 Instalação do Software 17

1.3 O Software Fritzing 20

1.3.1 Arquitetura Especifica do ATMega 23

1.4 Modelos do Arduino, Similares e Clones 27

1.4.1 Arduinos Certificados 32

1.4.2 Alguns Clones e Plataformas compatíveis 32

1.4.3 Cálculos de resistência e LED 37

1.4.3.1 Visão rápida sobre Resistências, Potenciometros e LDR 37
...
1.4.3.2 Visão rápida sobre LEDs 39

1.4.3.3 Cálculo do Resistor 40

1.4.4 Alguns Shields 43

1.4.4.1 Schmitt Trigger e portas digitais do Arduíno 50

1.4.4.2 PWM 51

Módulo 59

1 Fundamentos de Eletrônica 61

1.1 Resistência e Capacitância 63

1.1.1 Usando o Multímetro 63

1.2 Capacitores e indutores 68

1.2.0.1 Como ler os valores dos capacitores 69

Capacitores de Cerâmica Multicamada 73

Capacitores de Poliéster Metalizado usando código de cores 73

1.2.0.2 Capacitores em Série 74

1.2.0.3 Capacitores em Paralelo 74

1.2.1 Indutores 75

1.2.1.1 PWM e Ponte-H para controle de velocidade 90

2 Capítulo 91

2.1 Introdução 92

2.2 Convertendo Base numéricas 92

2.3 Portas Lógicas 96

2.4 Introdução a Lógica de Programação 102

2.4.1 O Arduino 4 Scratch 110

3 Capítulo 115

3.1 A História do Wiring 116

3.1.0.1 Declarando Constantes 122

3.1.0.2 Declarando Variáveis 123

3.1.0.3 Variáveis Voláteis. 123

3.1.0.4 Contexto das variáveis 123

3.1.1 Apelidos para valores máximos e Mínimos 125

3.2 Conversões de tipos 126

Conversão Implícita 126

Conversão Explicita 127

3.3 Estruturas de Controle 127

3.3.1 Blocos de Código 127
...
3.3.3 Estruturas de Controle em C/C++ 130

3.3.3.1 Estrutura Condicional 130

3.3.3.2 Estrutura de interação 132

3.3.3.3 Estrutura de Seleção 132

Módulo 133

1 Capítulo 135

1.1 Comunicações Seriais 137

1.1.1 Serial TTL e RS232 137

1.1.2 SPI 137

1.1.3 OneWire 137

1.1.4 I2C ou TWI? 137

1.2 Comunicações em Rede (via Ethernet, WiFi e outras Redes) 138

1.3.1 Ethernet 138

1.3.2 WiFi (Wireless 2.4Ghz) 138

1.3.3 ZigBee 138

1.3.4 SubGiga 138

1.3.5 GSM/GPRS (Celular) 138

2 Capítulo 139

3 Capítulo 145

3.1 Obtendo a Temperatura com LM35 ou TMP35 147

3.2 Apresentando a Temperatura no PC Graficamente 150

Modulo 5 153

0.1 Fazendo Barulho 1

0.2 Sistema de Segurança 7

0.3 Construindo seu Primeiro Joystick 9

0.4 Seu primeiro Carrinho Seguidor de Linha 11

0.5 Um sistema de gestão ambiental 13
